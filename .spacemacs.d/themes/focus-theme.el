;;; focus-theme.el --- A theme to allow people to focus.

;; Copyright (C) 2014 Anler Hp

;; Author: Anler Hp <anler86 [at] gmail.com>
;; Keywords: color, theme, focus
...
;;; Commentary:
;;
;; A focusistic color theme to avoid distraction with
;; colors. Based on monochrome theme.

;;; Code:
(deftheme focus "focus dark theme.")
